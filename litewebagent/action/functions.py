...
# def keyboard_insert_text_then_enter(text: str):
#     """
#     Insert a string of text in the currently focused element and then simulate
#     pressing the Enter key. This function combines keyboard_insert_text with
#     a keypress of the Enter key.
#
#     Examples:
#         keyboard_insert_text_then_enter('Hello world!')
#     """
#     page.keyboard.insert_text(text)
