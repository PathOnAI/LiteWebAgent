...
class WorkflowAgent:
    ...
    def set_goal(self, goal: str, start_page: str):
        ...
        template = f"""
        Your goal is to determine a workflow for a given task, that can be performed by a browser automation agent in a sequence of tasks, starting at {start_page}.
